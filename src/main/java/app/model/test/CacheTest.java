...
public class CacheTest {
	...
	public static void testIOSearch() throws Exception{
		...
		PrintWriter out = new PrintWriter(new FileWriter("src/main/java/app/model/test/text1.txt"));
		out.println(words1);
		out.close();
		out = new PrintWriter(new FileWriter("src/main/java/app/model/test/text2.txt"));
		out.println(words2);
		out.close();
		
		if(!IOSearcher.search("is", "src/main/java/app/model/test/text1.txt","src/main/java/app/model/test/text2.txt"))
			System.out.println("your IOsearch did not found a word (-5)");
		if(IOSearcher.search("cat", "src/main/java/app/model/test/text1.txt","src/main/java/app/model/test/text2.txt"))
			System.out.println("your IOsearch found a word that does not exist (-5)");		
	}
	
	public static void testDictionary() {
		Dictionary d = new Dictionary("src/main/java/app/model/test/text1.txt","src/main/java/app/model/test/text2.txt");
		if(!d.query("is"))
