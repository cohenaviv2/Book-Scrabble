...
public class ServerTest {
	...
	public static void testDM() {
		String t1[]=writeFile("src/main/java/app/model/test/t1.txt");
		String t2[]=writeFile("src/main/java/app/model/test/t2.txt");
		String t3[]=writeFile("src/main/java/app/model/test/t3.txt");
		
		DictionaryManager dm=DictionaryManager.get();
		
		if(!dm.query("src/main/java/app/model/test/t1.txt","src/main/java/app/model/test/t2.txt",t2[4]))
			System.out.println("problem for Dictionary Manager query (-5)");
		if(!dm.query("src/main/java/app/model/test/t1.txt","src/main/java/app/model/test/t2.txt",t1[9]))
			System.out.println("problem for Dictionary Manager query (-5)");
		if(dm.query("src/main/java/app/model/test/t1.txt","src/main/java/app/model/test/t3.txt","2"+t3[2]))
			System.out.println("problem for Dictionary Manager query (-5)");
		if(dm.query("src/main/java/app/model/test/t2.txt","src/main/java/app/model/test/t3.txt","3"+t2[5]))
			System.out.println("problem for Dictionary Manager query (-5)");
		if(!dm.challenge("src/main/java/app/model/test/t1.txt","src/main/java/app/model/test/t2.txt","src/main/java/app/model/test/t3.txt",t3[2]))
			System.out.println("problem for Dictionary Manager challenge (-5)");
		if(dm.challenge("src/main/java/app/model/test/t2.txt","src/main/java/app/model/test/t3.txt","src/main/java/app/model/test/t1.txt","3"+t2[5]))
			System.out.println("problem for Dictionary Manager challenge (-5)");
	...
	public static void testBSCH() {
		String s1[]=writeFile("src/main/java/app/model/test/s1.txt");
		String s2[]=writeFile("src/main/java/app/model/test/s2.txt");
		...
		runClient(port, "Q,src/main/java/app/model/test/s1.txt,src/main/java/app/model/test/s2.txt,2"+s1[1], false);
		runClient(port, "Q,src/main/java/app/model/test/s1.txt,src/main/java/app/model/test/s2.txt,3"+s2[4], false);
		runClient(port, "C,src/main/java/app/model/test/s1.txt,src/main/java/app/model/test/s2.txt,"+s1[9], true); //
		runClient(port, "C,src/main/java/app/model/test/s1.txt,src/main/java/app/model/test/s2.txt,#"+s2[1], false);
		s.close();
	}
